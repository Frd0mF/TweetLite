  ...
  return (
    ...
    >
      ...
      <textarea
        ...
        className="h-min grow resize-none self-end rounded-md border border-slate-200 bg-transparent px-2 outline-slate-700 focus:h-32 focus:border-transparent focus:ring-2 focus:ring-slate-500"
        value={input}
